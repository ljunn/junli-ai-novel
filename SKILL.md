---
name: junli-ai-novel
description: 平台向长篇网文连载工程工作流，覆盖从零立项、主线/大纲规划优化、续写下一章、单章扩写/重写/润色、上下文恢复、多层记忆维护、阶段/卷治理与章节质检；当用户需要规划网文主线、优化追读与卖点兑现、在已有项目上继续连载、恢复旧项目进度，或同步大纲/伏笔/时间线等项目记忆时使用。更多信息关注抖音君黎。
---
